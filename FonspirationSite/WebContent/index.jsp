  ...
  <div class="row">    
    ...
    <div class="large-3 pull-9 columns">
       ...
       <div class="section-container vertical-nav" data-section="vertical-nav" data-options="one_up: false;">
       	<section>
       		<p class="title" data-section-title><a href="#">My Quotes</a></p>
       	</section>
       	<section>
       		<p class="title" data-section-title><a  href="#">Inspires Me</a></p>
       	</section>
       	<section>
       		<p class="title" data-section-title><a href="#">My Wishlist</a></p>
       	</section>
       	<section>
       		<p class="title" data-section-title><a href="#">My Bids</a></p>
       	</section>
       	<section>
       		<p class="title" data-section-title><a href="#">My Details</a></p>
       	</section>
    ...
    <div class="large-12 columns">
      ...
      <div class="row">
        <div class="large-6 columns">
          <p>&copy; Fonspiration | All Rights Reserved</p>
        </div>
        <div class="large-6 columns">
